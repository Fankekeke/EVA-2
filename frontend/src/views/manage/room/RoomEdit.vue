  ...
  <a-modal v-model="show" title="修改房间" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='房间面积' v-bind="formItemLayout">
            <a-input-number style="width: 100%" :min="0" :step="0.1" v-decorator="[
            'area',
        ...
        <a-col :span="12">
          <a-form-item label='房间数量' v-bind="formItemLayout">
            <a-input-number style="width: 100%" :min="0" :step="1" v-decorator="[
            'roomNum',
...
export default {
  ...
  methods: {
    ...
    setFormValues ({...room}) {
      this.rowId = room.id
      let fields = ['name', 'price', 'area', 'roomNum', 'content']
      let obj = {}
      Object.keys(room).forEach((key) => {
        if (key === 'images') {
          this.fileList = []
          this.imagesInit(room['images'])
        }
