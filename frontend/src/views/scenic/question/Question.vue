          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.questTitle"/>
              </a-form-item>
            </a-col>
          </div>
...
<script>
  ...
  import UserAdd from './QuestionAdd'
  import UserEdit from './QuestionEdit'
  ...
  export default {
    ...
    computed: {
      columns() {
        ...
        return [{
          ...
          sorter: (a, b) => a.questTitle.length - b.questTitle.length,
          sortOrder: sortedInfo.columnKey === 'questTitle' && sortedInfo.order
        }, {
          title: '发贴时间',
          dataIndex: 'questDate',
        }, {
    ...
    methods: {
      ...
      fetch(params = {}) {
        ...
        this.$get('/scenic/question-info/page', {
          ...params
        }).then((r) => {
