          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                >
                  <a-select-option v-for="scenic in scenicList" :value="scenic.code" :key="scenic.code">{{scenic.scenicName}}</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
...
<script>
  ...
  import UserAdd from './OrderAdd'
  import UserEdit from './OrderEdit'
  ...
  export default {
        ...
        return [{
          ...
          customRender: (text, row, index) => {
            switch (text.toString()) {
              case '0':
                return <a-tag color="cyan">未使用</a-tag>
              case '1':
    ...
    methods: {
      ...
      getScenicList() {
        this.$get('/scenic/info/info/list', {
        }).then((r) => {
      ...
      fetch(params = {}) {
        ...
        this.$get('/scenic/order-info/page', {
          ...params
        }).then((r) => {
