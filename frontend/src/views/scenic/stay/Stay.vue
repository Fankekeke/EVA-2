          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.stayName"/>
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 4}"
                :wrapperCol="{span: 18, offset: 2}">
                <a-input v-model="queryParams.stayAddress"/>
              </a-form-item>
            </a-col>
          </div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon v-hasPermission="['user:update']" type="setting" theme="twoTone" twoToneColor="#4a9ff5"
                  @click="edit(record)" title="修改旅店"></a-icon>
...
<script>
  ...
  import UserAdd from './StayAdd'
  import UserEdit from './StayEdit'
  ...
  export default {
    ...
    computed: {
      columns() {
        ...
        return [{
          title: '旅店名称',
          dataIndex: 'stayName',
          sorter: (a, b) => a.stayName.length - b.stayName.length,
          sortOrder: sortedInfo.columnKey === 'stayName' && sortedInfo.order
        }, {
          title: '价格',
          dataIndex: 'stayPrice',
    ...
    methods: {
      ...
      batchDelete() {
        ...
        this.$confirm({
          ...
          onOk() {
            ...
            that.$delete('/scenic/stay-info/'+ids,).then(() => {
      ...
      fetch(params = {}) {
        ...
        this.$get('/scenic/stay-info/page', {
          ...params
        }).then((r) => {
