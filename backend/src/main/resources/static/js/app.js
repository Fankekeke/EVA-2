...
$(function () {
  ...
  function showTab(that){
    ...
    $("#content>.tabs-panel").eq(that.error()).show().siblings().hide();
    ...
    buildPagination($("#content>.tabs-panel").eq(that.error()).find(".diy_table_foot .pagination"));
    ajaxsearch($("#content>.tabs-panel").eq(that.error()).find("form[data-toggle='ajaxsearch']"))
  }
